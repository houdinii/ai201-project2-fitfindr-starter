...
| Rubric line                                                                                                                                                    | Pts | Exhibit required                                                   | Where it will live                                 | Status |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----|--------------------------------------------------------------------|----------------------------------------------------|--------|
| Demo or source shows a complete interaction that starts with a natural language user query and ends with a fit card, using all 3 required tools along the way. | 1   | Full happy-path run: query → search → outfit → fit card, on camera | Demo video                                         | ☑ src 2026-06-12 (agent.py: search→outfit→fit card). Demo video to reinforce. |
...
| Rubric line                                                                                                                                   | Pts | Exhibit required                                                                     | Where it will live                          | Status |
|-----------------------------------------------------------------------------------------------------------------------------------------------|-----|--------------------------------------------------------------------------------------|---------------------------------------------|--------|
| Demo or source shows that the item returned by search_listings is the same item passed into suggest_outfit — without the user re-entering it. | 1   | Print/narrate `session["selected_item"]` flowing into suggest_outfit                 | Demo video (+ EVIDENCE.md terminal capture) | ☑ src 2026-06-12 (`selected_item IS search_results[0]: True`, EVIDENCE.md). Demo video to reinforce. |
| Demo or source shows the outfit from suggest_outfit passing into create_fit_card without re-entry.                                            | 1   | Print/narrate `session["outfit_suggestion"]` flowing into create_fit_card            | Demo video (+ EVIDENCE.md terminal capture) | ☑ src 2026-06-12 (executor injects `session["outfit_suggestion"]` into create_fit_card, EVIDENCE.md). Demo video to reinforce. |
...
## Progress
**Required rows ticked: 9 / 24** (planning.md Quality 4/4. Multi-step walkthrough via planning.md. Milestone 4 added 4 source-satisfied rows 2026-06-12: complete interaction, both state-management flow rows, and the 2-pt planning-loop adaptiveness row, all backed by agent.py CLI output in EVIDENCE.md. These rows say "Demo or source" and the repo source satisfies them now. Demo video will reinforce. Still open: the README-description rows for Planning Loop, State Management, Error Handling, README Completeness, AI Usage, plus the on-camera demo and the four stretch units.)